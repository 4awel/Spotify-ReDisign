...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-home" }, _attrs))} data-v-93d5897a>`);
  _push(ssrRenderComponent(_component_HeaderHome, null, null, _parent));
  _push(`<div class="block-content" data-v-93d5897a><div class="header-content-home" data-v-93d5897a><div class="header-text" data-v-93d5897a><h1 data-v-93d5897a>Made For You</h1></div>`);
  ...
  _push(`</div><div class="main-content-home cards" data-v-93d5897a><div${ssrRenderAttrs({
    name: "card-slide",
    class: "cards-container"
  })} data-v-93d5897a>`);
  ssrRenderList(_ctx.currentSlideFst, (item, index2) => {
    _push(`<div class="home-card" style="${ssrRenderStyle({ "--card-index": index2 })}" data-v-93d5897a><div class="img-card" data-v-93d5897a><img${ssrRenderAttr("src", item.image)} alt="default-img" data-v-93d5897a></div><div class="content-card" data-v-93d5897a><div class="content-card-header" data-v-93d5897a><h4 data-v-93d5897a>${ssrInterpolate(item.title)}</h4><span class="count-track" data-v-93d5897a>${ssrInterpolate(item.count)}</span></div><div class="content-card-description" data-v-93d5897a><span data-v-93d5897a>${ssrInterpolate(item.description)}</span></div></div></div>`);
  });
  _push(`</div></div><div class="header-content-home" data-v-93d5897a><div class="header-text" data-v-93d5897a><h1 data-v-93d5897a>Your Top Mixes</h1></div>`);
  _push(ssrRenderComponent(_component_ActionGroupButton, {
  ...
  _push(`</div></div><div class="header-content-home" data-v-93d5897a><div class="header-text" data-v-93d5897a><h1 data-v-93d5897a>Your Favorite Artists</h1></div>`);
  _push(ssrRenderComponent(_component_ActionGroupButton, {
  ...
  ssrRenderList(_ctx.currentSlideThrd, (item, index2) => {
    _push(`<div class="home-card artist-card" style="${ssrRenderStyle({ "--card-index": index2 })}" data-v-93d5897a><div class="img-card-radius" data-v-93d5897a><img${ssrRenderAttr("src", item.image)} alt="artist-img" data-v-93d5897a></div><div class="content-card" data-v-93d5897a><div class="content-card-header" data-v-93d5897a><h4 class="overlight" data-v-93d5897a>${ssrInterpolate(item.name)}</h4></div></div></div>`);
  });
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-93d5897a"]]);

export { index as default };
//# sourceMappingURL=index-C6DJTRSs.mjs.map
